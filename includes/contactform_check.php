<?php
			...
			$city		=	$_POST['woonplaats'];	// verplicht veld
		...
		//IF ERROR SHOW FOLLOWING
			...
			if ($error == 1)
			{
				...
				if(empty($city)|| $emailerror	== 1){$cityclass	=	"class='errorinfo'";}
				...
				<form action="?m=c" method="post" enctype="application/x-www-form-urlencoded" name="error_contact">
					<table>
    					...
    					<tr>
        					...
        					<td>
        						<input name="woonplaats" type="text" size="50" value="<?php echo $cityclass; ?>"/>
        					</td>
    					</tr>
        					<td valign="top">
        						*
